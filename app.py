...
class JobAdAnalyzer:
    ...
    def analyze_job_ad(self, job_ad_text):
        ...
        Note that in this specific case of Job Ad, the following topics should not be mentioned in the response: it is NOT necessary to include multiple currencies for salary, it is NOT necessary to include metrics for responsibilities, it is NOT necessary for job ads to appeal to multiple international candidates, it is NOT necessary to include contact details, it is NOT necessary to include a company logo, it is NOT necessary to include information about the application process, it is NOT necessary for quantifiable targets to be included, it is NOT necessary for extensive information about the company to be included as long as some company information is included, it is NOT necessary for information about team structure and career progression to be included, it is NOT necessary for information about contract type to be included, it is NOT necessary for information about reporting structure to be included.
